...
def get_args():
    ...
    parser.add_argument("--log_path", type=str, default="tensorboard/double_train_pr_A0.6_B0_1")
    parser.add_argument("--saved_path", type=str, default="trained_models/double_train_pr_A0.6_B0_1")
    ...
    parser.add_argument("--beta", type=float, default=0, help="beta in replay")
...
def train(opt):
    ...
    while iter < opt.num_iters:
        ...
        iter += 1
        if iter % 100 == 0:
            print("Test::PR: Iteration: {}/{}, Action: {}, Loss: {}, Epsilon {}, Reward: {}, Q-value: {}".format(
                iter + 1,
                opt.num_iters,
                action,
                loss,
